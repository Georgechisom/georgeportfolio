...
import { Bag, ContactImage, Design, DeskImage } from '../../assets/AllImages';
...
const Intro = () => {
  ...
  return (
    <section className='max-w-screen-xl mx-auto w-full h-full  overflow-hidden mt-10 lg:mt-10 relative flex flex-col lg:flex-row items-start gap-2 px-1 lg:px-5 lg:grid-cols-2 intro'>
      <Aside />
      <aside className={aside ? 'lg:hidden fixed top-[10%] z-20 mt-8 py-4 px-4 flex flex-col items-center justify-center gap-y-2 overflow-hidden border-2 border-skyText rounded-xl smallbg w-[97%]' : 'hidden'}>
        <div className='flex flex-row items-center justify-center gap-2 w-full my-1'>
          <img src={Design} alt="GeorgeChisom" className="w-20 mr-auto" />
          <div className='text-base md:text-xl mx-auto text-skyText font-bold text-nowrap py-1 text-center md:w-full'>George Chisom</div>
        </div>
      ...
      <div className='h-full w-full p-8 text-3xl md:text-4xl lg:text-5xl font-extrabold flex flex-col justify-center gap-y-2 overflow-hidden'>
          ...
          <span className='specialAnimation py-2'>I'm <span className='text-skyText'>George Chisom</span></span>
            <p className='hidden lg:flex text-lg lg:text-xl font-medium py-2'>
              A passionate Web3 developer with a knack for crafting engaging, user friendly  applications that make an impact. My skill set covers a wide range of front end tools like HTML, CSS, Bootstrap, React, and React Native, paired with strong back end expertise in PHP, MySQL, and Laravel. I thrive on writing clean, optimized code and tackling tough challenges with creative solutions. <br/> <br />
              In the Web3 space, I'm at home with Solidity, building innovative blockchain solutions with precision and flair. My blend of technical know how, problem solving grit, and enthusiasm for pushing boundaries makes me a dynamic team player ready to drive success in exciting web and app development projects.
            </p>
            <p className='flex lg:hidden text-lg lg:text-xl font-medium py-2'>
              A passionate Web3 developer who builds user friendly, impactful apps. I'm skilled in frontend tools like HTML, Tailwind CSS, Bootstrap, React, and React Native, and back end tech like PHP, MySQL, and Laravel also gain expertise in WORDPRESS over the years. I write clean, efficient code and solve tough challenges creatively. <br/> In Web3, I excel with Solidity, crafting innovative blockchain solutions. My technical skills, problem-solving drive, and enthusiasm make me a dynamic team player ready to succeed in web and app development projects.
            </p>
