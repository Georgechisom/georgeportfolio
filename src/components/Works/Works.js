...
const Works = () => {
  return (
    <section className='max-w-screen-xl mx-auto w-full overflow-hidden flex flex-col items-center justify-center text-center my-2'>
        ...
        <button className='rounded-full border-b-2 border-r-2 border-t-0 shadow-sm shadow-skyText border-skyText py-3 px-8 my-4 font-semibold hover:bg-white hover:text-skyText hover:border-none hover:shadow-md hover:rounded-full hover:shadow-skyText hover:font-bold'>
            See More
        </button>
    </section>
  );
