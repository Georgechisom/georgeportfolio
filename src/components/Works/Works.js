...
const Works = () => {
  return (
    <section className='max-w-screen-xl mx-auto w-full h-full  overflow-hidden mt-10 relative flex flex-col lg:flex-row items-start gap-2 px-1 lg:px-5 lg:grid-cols-2 works'>
        <Aside className="hidden lg:flex" />
        <div className='h-full w-full p-8 flex flex-col justify-center gap-y-2 overflow-hidden'>
            <h2 className='text-2xl md:text-3xl lg:text-4xl font-extrabold text-center py-6 md:py-10 mb-5'>My Portfolio</h2>
            <span className='font-medium text-sm sm:text-base py-0 px-6 lg:px-2 text-center'>
            ...
            <div className='flex flex-row flex-wrap items-center justify-center gap-4 lg:gap-4 my-10'>
                ...
                <Link to='https://meme-generator-app-delta.vercel.app/' className='flex hover:border-2 hover:border-skyText shadow-md shadow-skyText lg:hidden flex-col gap-2 items-center justify-center rounded-lg py-3 px-3 data-[focus]:bg-white/50 tracking-wide hover:cursor-pointer hover:shadow-md hover:shadow-skyText'>
            ...
            <button className='rounded-full border-b-2 border-r-2 border-t-0 shadow-sm shadow-skyText border-skyText py-3 px-8 my-4 font-semibold hover:bg-white hover:text-skyText hover:border-2 hover:shadow-md hover:rounded-full hover:shadow-skyText hover:font-bold w-44 mx-auto'>
                See More
            </button>
        </div>
    </section>
