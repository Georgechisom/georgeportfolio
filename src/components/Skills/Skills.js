...
const Skills = () => {
  return (
    <section className='max-w-screen-xl mx-auto w-full overflow-hidden flex flex-col items-center justify-center text-center my-0'>
        <span className='text-2xl md:text-3xl lg:text-4xl font-extrabold pt-12 mb-5'>What I Do</span>
        <span className='font-medium text-base py-0 px-6 '>
        ...
        <div className='w-full m-6 text-left max-w-6xl'>
            <div className='flex flex-col md:flex-row lg:flex-row items-center m-4 py-4 md:py-6 px-3 md:px-8 border b-2 border-skyText rounded-lg shadow-md shadow-skyText mb-8 gap-x-1 lg:gap-y-0 lg:gap-x-10 md:gap-x-10 bg-whiteText hover:shadow-lg hover:shadow-skyText'>
                ...
                <div>
                    <h2 className='font-bold text-skyText text-center lg:text-left md:text-left mb-2'>UI/UX Design</h2>
            ...
            <div className='flex flex-col md:flex-row lg:flex-row items-center m-4 py-4 md:py-6 px-3 md:px-8 border b-2 border-skyText rounded-lg shadow-md shadow-skyText mb-8 gap-x-1 lg:gap-y-0 lg:gap-x-10 md:gap-x-10 bg-whiteText hover:shadow-lg hover:shadow-skyText'>
                ...
                <div>
                    <h2 className='font-bold text-skyText text-center lg:text-left md:text-left mb-2'>Website Design</h2>
            ...
            <div className='flex flex-col md:flex-row lg:flex-row items-center m-4 py-4 md:py-6 px-3 md:px-8 border b-2 border-skyText rounded-lg shadow-md shadow-skyText mb-8 gap-x-0 lg:gap-y-0 lg:gap-x-10 md:gap-x-10 bg-whiteText hover:shadow-lg hover:shadow-skyText'>
                <img src={appDesign} alt='uiImage' className='object-cover w-14 md:w-20' />
                <div>
                    <h2 className='font-bold text-skyText text-center lg:text-left md:text-left mb-2'>App Design</h2>
